...
<div class="row">
			<div class="col-md-12">
				<a href="aktivitasPerkuliahan/DownloadAktivitasPerkuliahan.php" class="label label-info">1. Download contoh Aktivitas Kuliah *.xls</a>
				...
				<p>
					...
					if(isset($_POST['submit'])){
						...
						$row=$aktivitas_kul1->rowcount($sheet_index=0);
							...
							<button class="btn btn-xs btn-info" onclick="location.href='aktivitasPerkuliahan/import_aktiitas_perkuliahan.php'"><span class="glyphicon glyphicon-paperclip"></span> 4. Import ke Feeder</button>
			...
			<?php 
				...
				if($result1->num_rows>0){
					while ($result=$result1->fetch_assoc()) { 
							if(($result["id_registrasi_mahasiswa"]=='')||($result["id_status_mahasiswa"]=='')){
