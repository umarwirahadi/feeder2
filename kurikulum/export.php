...
$id_kurikulum=strip_tags($_GET['idkurikulum']);
$sql="select Nama_kurikulum,kode_mata_kuliah,nama_mata_kuliah,sks_mata_kuliah,nama_program_studi,semester,id_semester,semester_mulai_berlaku,apakah_wajib from getmatkulkurikulum where id_kurikulum='$id_kurikulum'";
if($res=$cn->query($sql)){
