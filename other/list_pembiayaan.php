...
<div class="row">
	<div class="panel panel-default">
		    <div class="panel-heading">[ Data Jenis pembiayaan ]</div>
		...
		<!-- <div class="table-responsive"> -->
			...
			<table class="table table-bordered table-hover">
				<tr class="">
					...
					<td class="label-primary" width="50"><b>ID PEMBIAYAAN</b></td>
					<td class="label-primary" width="300"><b>NAMA PEMBIAYAAN</b></td>
...
<script>
	$(document).ready(function(){
		$("#updateagama").click(function(){
			$("#isii").load("other/get_pembiayaan.php");
		});
	});
</script>